...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "請注意路况，這是輔助駕駛", alert_status=AlertStatus.normal):
    super().__init__(alert_text_1, alert_text_2,
...
def calibration_incomplete_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  return Alert(
    ...
    f"請保持車速速高于 {get_display_speed(MIN_SPEED_FILTER, metric)}",
...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventName.startup: {
    ET.PERMANENT: StartupAlert("請随时準備接管")
  },
  ...
  EventName.carUnrecognized: {
    ET.PERMANENT: NormalPermanentAlert("目前處於行車紀錄模式",
                                       '請點擊設置⚙️ -> "車輛設置" 選擇車型',
                                       priority=Priority.LOWEST),
  },
  ...
  EventName.overheat: {
    ...
    ET.SOFT_DISABLE: soft_disable_alert("系统過熱"),
    ET.NO_ENTRY: NoEntryAlert("系统過熱"),
  },

  EventName.wrongGear: {
    ET.SOFT_DISABLE: user_soft_disable_alert("請先切换到D檔"),
    ET.NO_ENTRY: NoEntryAlert("請先切换到D檔"),
  },
  ...
  EventName.doorOpen: {
    ET.SOFT_DISABLE: user_soft_disable_alert("門没關好"),
    ET.NO_ENTRY: NoEntryAlert("門没關好"),
  },

  EventName.seatbeltNotLatched: {
    ET.SOFT_DISABLE: user_soft_disable_alert("請繫好安全带"),
    ET.NO_ENTRY: NoEntryAlert("請繫好安全带"),
  },
